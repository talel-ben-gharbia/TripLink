...
function TravelerProfile() {
    ...
    fetch(`${API_URL}/api/profile`, {
      ...
      .then((data) => {
        if (data.user) {
          ...
          fetch(`${API_URL}/api/profile/reviews`, {
            headers: { Authorization: `Bearer ${token}` },
          })
            .then((res) => res.json())
  ...
  const resetPersonality = () => {
    const base = Object.keys(personalityAxis).reduce((acc, k) => {
      acc[k] = 50;
      return acc;
    }, {});
  ...
  const resetCategories = () => {
    const base = Object.keys(preferences).reduce((acc, k) => {
      acc[k] = 50;
      return acc;
    }, {});
    setPreferences(base);
      ...
      <div>
        <div className="mb-6 bg-white rounded-2xl p-6 shadow-lg border border-white/60">
          ...
          <div className="w-full bg-gray-200 rounded-full h-3 mb-3 overflow-hidden">
            <div
              className="bg-gradient-to-r from-purple-600 via-blue-500 to-cyan-500 h-3 rounded-full"
      ...
      <div className="bg-white rounded-2xl p-6 shadow-lg border border-white/60">
        ...
        <div className="flex flex-wrap gap-2">
          {items.map((it) => (
            <span
              key={it.key}
              className="inline-flex items-center px-3 py-1 rounded-full text-sm font-semibold bg-purple-50 text-purple-700 border border-purple-100"
            >
              <span className="mr-2">{emoji(it.key)}</span>
              {it.key.replace(/([A-Z])/g, " $1").trim()}{" "}
              <span className="ml-2 text-xs text-gray-600">{it.value}%</span>
            </span>
          ))}
        </div>
      </div>
          ...
          <div className="glass-card p-8 mb-8 glass-ring ambient-glow animate-fade-up">
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center space-x-6">
                <div className="w-20 h-20 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 rounded-2xl overflow-hidden flex items-center justify-center shadow-xl ring-4 ring-white">
                  {avatarPreview ? (
                    <img
                      src={
                        String(avatarPreview).startsWith("http")
                          ? avatarPreview
                          : `${API_URL}/uploads/profiles/${avatarPreview}`
                      }
                      alt="Profile"
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-base font-medium mt-1">
                    Customize your travel preferences and personality
                  </p>
                  {user.id && (
                    <a
                      ...
                      className="mt-2 inline-flex items-center gap-2 text-sm text-purple-600 hover:text-purple-700 transition-colors"
                    >
                      View Public Profile
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="relative bg-gradient-to-br from-purple-50 via-blue-50 to-pink-50 rounded-2xl shadow-2xl p-6 border border-purple-200 overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <div className="text-center mb-6">
                      <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-purple-600 to-blue-500 rounded-full overflow-hidden flex items-center justify-center shadow-xl border-4 border-white">
                        {avatarPreview ? (
                          <img
                            src={
                              String(avatarPreview).startsWith("http")
              ...
              <div className="lg:col-span-2">
                <div className="bg-white rounded-2xl shadow-2xl p-6 border border-purple-50 flex flex-col max-h-[calc(100vh-12rem)]">
                  <div
                    className="flex gap-6 mb-6 border-b flex-shrink-0 overflow-x-auto"
                    role="tablist"
                  ...
                  >
                    {tabs.map((tab) => (
                      <button
                        ...
                        className={`pb-3 px-5 capitalize relative z-10 whitespace-nowrap flex-shrink-0 ${
                          activeTab === tab
                      ...
                      >
                        {tab === "wishlist" ? (
                          <span className="inline-flex items-center">
                            wishlist
                            <span className="ml-2 inline-flex items-center justify-center min-w-[22px] h-5 px-2 rounded-full text-xs font-bold bg-purple-100 text-purple-700 border border-purple-200">
                              {wishlist.length}
                            </span>
                          </span>
                        ) : (
                    ...
                    {activeTab === "preferences" && (
                      ...
                      >
                        ...
                        >
                          {["personality", "categories"].map((t) => (
                            <button
                              ...
                              className={`pb-3 px-4 capitalize relative z-10 ${
                                preferencesSubTab === t
                                  ? "border-b-2 border-purple-600 text-purple-600 font-semibold"
                                  : "text-gray-600 hover:text-purple-600"
                              }`}
                        ...
                        {preferencesSubTab === "personality" && (
                          <div
                            id="subpanel-personality"
                            role="tabpanel"
                            aria-labelledby="pref-personality"
                            className="space-y-8"
                          >
                            <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200">
                              <div className="flex items-center justify-between mb-4">
                              ...
                              <div className="flex items-center justify-end mb-3 space-x-2">
                                <button
                                  ...
                                  className="px-3 py-1 text-xs rounded-md border border-gray-300 hover:border-purple-500 hover:text-purple-700 bg-white shadow-sm flex items-center space-x-1"
                                >
                                  <RefreshCw size={14} />
                                  <span>Reset</span>
                                </button>
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                {Object.entries(personalityAxis).map(
                                  ([axis, value]) => (
                                    <div
                                      key={axis}
                                      className="space-y-3 p-4 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition overflow-hidden"
                                    >
                                      <div className="flex justify-between items-center">
                                        <div
                                          className="flex items-center font-semibold text-gray-900 text-sm capitalize truncate"
                                          title={axisDescriptions[axis]}
                                        >
                                          <div
                                        ...
                                        <span className="inline-flex items-center px-2 py-1 rounded-full bg-gray-100 text-gray-800 text-xs font-bold whitespace-nowrap">
                                          {value}%
                                        </span>
                                      </div>
                                      <div className="relative">
                                        <input
                                          ...
                                          value={value}
                                          onChange={(e) =>
                                            updatePersonalityAxis(
                                              axis,
                                              parseInt(e.target.value)
                                            )
                                          }
                                          aria-label={`Adjust ${axis}`}
                                          className="w-full h-3 rounded-lg appearance-none cursor-pointer slider-custom accent-purple-600 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2"
                                      ...
                                      <PolarAngleAxis
                                        ...
                                        tick={({
                                          ...
                                          <text
                                            ...
                                            y={y + (y - cy) / 10}
                                            x={x + (x - cx) / 20}
                                            className="text-xs font-bold text-gray-700 fill-current"
                                          >
                                            {payload.value}
                                          </text>
                                        )}
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-700">
                                    Adjust the sliders to tune your travel
                                    personality.
                                  </p>
                                </div>
                              </div>
                        ...
                        {preferencesSubTab === "categories" && (
                          <div
                            id="subpanel-categories"
                            role="tabpanel"
                            aria-labelledby="pref-categories"
                            className="space-y-8"
                          >
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                              {preferenceCategories.map((category) => (
                                <div
                                  key={category.title}
                                  className="space-y-6 p-5 bg-white rounded-2xl border border-gray-200 shadow-sm hover:shadow-md transition-all duration-300 animate-fade-up"
                                >
                                  <div className="flex items-center space-x-3">
                                    <div
                                  ...
                                  {category.items.map((item) => (
                                    <div key={item} className="space-y-3">
                                      <div className="flex justify-between items-center">
                                        <label
                                          className="text-sm font-semibold text-gray-900 capitalize flex items-center"
                                          title={`${item
                                            .replace(/([A-Z])/g, " $1")
                                            .trim()} preference level`}
                                        >
                                          <div
                                      ...
                                      <div className="relative">
                                        <input
                                          ...
                                          aria-label={`Adjust ${item}`}
                                          className="w-full h-3 rounded-lg appearance-none cursor-pointer slider-custom accent-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2"
                            ...
                            <div className="mt-2 p-6 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl border border-white/50 animate-fade-up">
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-gray-700">
                                    Preferences auto-save and influence
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {wishlist.length > 0 && (
                            <button
                              ...
                              className="px-3 py-1 rounded-md bg-red-50 text-red-700 border border-red-200 hover:bg-red-100"
                            >
                              Clear all
                            </button>
                          )}
                        ...
                        {wishlistLoading ? (
                          ...
                          <div className="bg-white/70 rounded-xl p-6 border border-white/40 text-center">
                            <p className="text-gray-700 mb-4">
                              No items yet. Browse destinations and tap the
                              heart to save.
                            </p>
                            <button
                              type="button"
                              onClick={() => navigate("/destinations")}
                              className="px-5 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-500 text-white shadow"
                            >
                              Browse destinations
                            </button>
                          </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                              {wishlist.map((d) => {
                                ...
                                return (
                                  <div
                                    key={d.id}
                                    className="bg-white rounded-2xl shadow-md border overflow-hidden flex flex-col h-full hover:shadow-lg transition-shadow"
                                  >
                                    ...
                                    <div className="p-4 flex flex-col gap-2 flex-1">
                                      ...
                                      <div className="mt-auto flex items-center justify-between pt-2">
                                        <button
                                          ...
                                          className="px-4 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-blue-500 text-white shadow hover:opacity-90"
                                        >
                                          View details
                                        </button>
                                        <button
                      ...
                      >
                        ...
                        {reviewsLoading ? (
                          ...
                          <div className="bg-white/70 rounded-xl p-8 border border-white/40 text-center">
                            ...
                            />
                            <p className="text-gray-700 mb-4">
                              You haven't written any reviews yet. Start
                              exploring destinations and share your experiences!
                            </p>
                            <button
                              type="button"
                              onClick={() => navigate("/destinations")}
                                ...
                                <div className="flex items-start justify-between mb-3">
                                  <div className="flex-1">
                                    <div className="flex items-center gap-3 mb-2">
                                      <h3
                                        ...
                                        onClick={() =>
                                          navigate(
                                            `/destinations/${review.destination.id}`
                                          )
                                        }
                                      >
                                    ...
                                    <div className="flex items-center gap-2 mb-2">
                                      ...
                                      {review.isPublic !== undefined && (
                                        <span className="ml-2 inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs bg-gray-100 text-gray-600">
                                          {review.isPublic ? (
                                            <>
                                              <Globe size={12} />
                                              Public
                                  ...
                                  {review.destination.image && (
                                    <img
                                      ...
                                      className="w-24 h-24 rounded-lg object-cover ml-4 cursor-pointer"
                                      onClick={() =>
                                        navigate(
                                          `/destinations/${review.destination.id}`
                                        )
                        ...
                        {activityLoading ? (
                          ...
                          <>
                              ...
                              <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-2xl font-bold text-gray-900">
                                      {activity.stats?.totalWishlistItems || 0}
                                    </div>
                                  </div>
                                </div>
                              </div>
                              <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                                <div className="flex items-center gap-3 mb-2">
                                  ...
                                  <div>
                                    ...
                                    <div className="text-2xl font-bold text-gray-900">
                                      {activity.stats?.averageRatingGiven
                                        ? activity.stats.averageRatingGiven.toFixed(
                                            1
                                          )
                                        : "—"}
                                    </div>
                            ...
                            {activity.activityTimeline &&
                              activity.activityTimeline.length > 0 && (
                                <div className="bg-white rounded-xl shadow-md p-6 border border-gray-200">
                                  <h3 className="text-lg font-bold text-gray-800 mb-4 flex items-center gap-2">
                                    <Activity size={20} />
                                    Activity Timeline
                                  ...
                                  <div className="space-y-3 max-h-96 overflow-y-auto">
                                    {activity.activityTimeline.map((log) => (
                                      <div
                                        key={log.id}
                                          ...
                                          <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {log.metadata?.destinationName && (
                                              <span
                                                ...
                                                onClick={() =>
                                                  navigate(
                                                    `/destinations/${log.metadata.destinationId}`
                                                  )
                                                }
                                              >
                                                {log.metadata.destinationName}
                                            ...
                                            <div className="flex items-center gap-1 mb-1">
                                              {[1, 2, 3, 4, 5].map((star) => (
                                                <Star
                                                  ...
                                                  size={12}
                                                  className={
                                                    star <= log.metadata.rating
                                                      ? "text-yellow-500 fill-current"
                                                      : "text-gray-300"
                                                  }
                                                />
                                              ))}
                                              {log.metadata.isPublic !==
                                                undefined && (
                                ...
                                <div className="flex items-center space-x-4 mb-4">
                                  <div className="w-16 h-16 rounded-full overflow-hidden bg-purple-100 flex items-center justify-center">
                                    {avatarPreview ? (
                                      <img
                                        src={
                                          String(avatarPreview).startsWith(
                                            "http"
                                          )
                                            ? avatarPreview
                                            : `${API_URL}/uploads/profiles/${avatarPreview}`
                                    ...
                                    <div
                                      className={`w-full h-full flex items-center justify-center text-purple-700 ${
                                        avatarPreview ? "hidden" : ""
                                      }`}
                                    >
                                      <User size={24} />
                              ...
                              <div className="bg-white rounded-xl shadow-md p-5 border border-gray-200">
                                ...
                                <div className="space-y-3">
                                  <button
                                    ...
                                    className="px-3 py-1 text-xs rounded-md border border-gray-300 hover:border-red-500 hover:text-red-600 bg-white shadow-sm"
                                  >
                                    {deleteConfirmOpen ? "Hide" : "Show"}{" "}
                                    Confirmation
                                  </button>
                                  {deleteConfirmOpen && (
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
